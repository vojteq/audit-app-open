...
export default function ListOfTasksEndangeredBarChart({ data, ...props }) {
      ...
      tooltip={(d) => {
        return (
          <div>
            ...
            {!!d.data.daysToPlannedDate ? (
              d.data.daysToPlannedDate < 0 ? (
                <TooltipRow>
                  Dni po planowanej dacie zakończenia:{" "}
                  <TooltipRowValue>
                    {-1 * d.data.daysToPlannedDate}
                  </TooltipRowValue>
                </TooltipRow>
              ) : (
                <TooltipRow>
                  Dni do planowanej daty zakończenia:{" "}
                  <TooltipRowValue>{d.data.daysToPlannedDate}</TooltipRowValue>
                </TooltipRow>
              )
            ) : null}
          </div>
